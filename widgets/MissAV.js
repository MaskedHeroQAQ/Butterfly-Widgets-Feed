WidgetMetadata = {
  id: "missav",
  title: "MissAV",
  description: "获取 MissAV 推荐、聚合搜索与站内搜索",
  author: "flymec / MaskedHeroQAQ",
  version: "2.1.0",
  ...
  modules: [
    {
      id: "missav.site-search",
      title: "站内搜索（点右侧箭头）",
      description: "使用 MissAV 自带搜索，可选择排序和页码",
      requiresWebView: true,
      functionName: "searchVideosSite",
      cacheDuration: 0,
      params: [
        {
          name: "keyword",
...
async function searchVideosSite(params = {}) {
