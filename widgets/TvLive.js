...
async function getLiveTv(params = {}) {
  try {
    const response = await Widget.http.get("https://raw.githubusercontent.com/MaskedHeroQAQ/Butterfly-Widgets-Feed/main/data/iptv-data.json");
    ...
    const url = params.url || "https://gist.githubusercontent.com/2kuai/d8e81b63e272dd838f372079bd204b42/raw/aptv";
